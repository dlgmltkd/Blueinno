...
#define PINS_COUNT_EXT		(14u)
//#define PINS_COUNT           (19u)
#define DIGTAL_PINS_CNT		(22u)

#define BlueInnoPinMap(ulPin) {if(ulPin > 7)	ulPin = ulPin + 4;}
	
/* Pins descriptions to be instantiated into variant.cpp */
extern uint8_t PPI_Channels_Occupied[PINS_COUNT+PINS_COUNT_EXT][2];
extern uint8_t GPIOTE_Channels_Occupied[PINS_COUNT+PINS_COUNT_EXT];
...
extern uint8_t Pin_Occupied_for_PWM[PINS_COUNT+PINS_COUNT_EXT]; // Determines if particular pin is occupied for PWM output
 ...
 * Wire Interfaces
 */
#define PIN_WIRE_SDA         (5u) // (6u)
#define PIN_WIRE_SCL         (6u) // (5u)
 ...
 */
#define UART_DEFAULT_RX_PIN		21//11 
#define UART_DEFAULT_TX_PIN		19//9
